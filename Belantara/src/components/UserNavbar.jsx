...
import { Settings, Plus, LayoutDashboard, Menu, X } from 'lucide-react';
          ...
          <div className="mt-6 space-y-1">
            ...
            <button
              className={`w-full flex items-center px-4 py-3 rounded-lg transition-colors ${
                location.pathname === '/user/dashboard' || location.pathname === '/user' || location.pathname === '/user/'
            ...
            <button
              ...
              onClick={() => goTo('/user/create-ticket')}
            >
